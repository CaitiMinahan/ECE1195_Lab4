...
proc create_root_design { parentCell } {
  ...
  set block_name DataPath
  set block_cell_name DataPath_0
  if { [catch {set DataPath_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DataPath_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axi_regmap_0/S_AXI]
  ...
  connect_bd_net -net DataPath_0_MemAddress [get_bd_pins DataPath_0/MemAddress] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net DataPath_0_MemWrite [get_bd_pins DataPath_0/MemWrite] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net DataPath_0_MemWriteData [get_bd_pins DataPath_0/MemWriteData] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net axi_regmap_0_REG0_OUT [get_bd_pins DataPath_0/Reset] [get_bd_pins axi_regmap_0/REG0_IN] [get_bd_pins axi_regmap_0/REG0_OUT] [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins DataPath_0/MemData] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_regmap_0/S_AXI_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DataPath_0/Clock] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_regmap_0/S_AXI_ACLK] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
